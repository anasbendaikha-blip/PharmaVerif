      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Vérifiez automatiquement vos factures de grossistes pharmaceutiques et 
            détectez les remises manquantes en quelques clics
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <Card className="bg-white border-blue-200">
            <CardContent className="p-6 text-center">
              <p className="text-4xl font-bold text-blue-600 mb-2">{formatCurrency(stats.montantRecuperable)}</p>
              <p className="text-gray-600">Récupérables ce mois</p>
            </CardContent>
          </Card>
          <Card className="bg-white border-green-200">
            <CardContent className="p-6 text-center">
              <p className="text-4xl font-bold text-green-600 mb-2">{formatPercentage(stats.tauxConformite)}</p>
          ...
          <Card className="bg-white border-orange-200">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">Anomalies détectées</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-blue-700 border-0">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
              Commencez dès maintenant à vérifier vos factures et récupérez les remises qui vous sont dues
            </p>
            <Button 
              size="lg"
              onClick={() => onNavigate('verification')}
