      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Une question sur PharmaVerif ? Intéressé par une licence d'utilisation ? 
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-2">Licences & Partenariats</h3>
                  <p className="text-sm text-gray-600 mb-3">
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-green-50 border-2 border-blue-200">
          <CardContent className="p-8">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">À propos du développeur</h2>
              <div className="max-w-2xl mx-auto space-y-3 text-gray-700">
                ...
                <p className="text-sm">
                  Cette application prototype illustre la conception d'un système intelligent de vérification 
                  de factures pharmaceutiques avec détection automatique d'anomalies.
                </p>
              </div>
              <div className="mt-6 pt-6 border-t border-blue-200">
                ...
                <p className="text-sm text-gray-600">
                  <strong>Portfolio :</strong> <a href="https://www.votre-portfolio.com" className="text-blue-600 hover:underline">www.votre-portfolio.com</a>
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-6">
          <p className="text-sm text-amber-800 text-center">
            <strong>Note importante :</strong> Cette version est un prototype de démonstration. 
            Les adresses email affichées sont fictives et à titre d'illustration uniquement.
          </p>
        </div>
      </div>
    </div>
