...
export function Logo({ 
  ...
  if (variant === 'icon') {
    return (
      ...
      >
        <defs>
          <linearGradient id={`shieldGradient-${size}`} x1="25" y1="5" x2="25" y2="45" gradientUnits="userSpaceOnUse">
        ...
        <g opacity="0.95">
          <rect x="23" y="15" width="4" height="14" rx="1" fill={theme === 'dark' ? '#1F2937' : 'white'} />
          <rect x="18" y="20" width="14" height="4" rx="1" fill={theme === 'dark' ? '#1F2937' : 'white'} />
        </g>
  ...
  if (variant === 'horizontal') {
    ...
    return (
      ...
      >
        <defs>
          <linearGradient id={`shieldGrad-${size}`} x1="20" y1="5" x2="20" y2="35" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor={theme === 'dark' ? '#60A5FA' : '#3B82F6'} />
            <stop offset="100%" stopColor={theme === 'dark' ? '#3B82F6' : '#2563EB'} />
          </linearGradient>
        </defs>
        ...
        <g id="icon-compact">
          ...
          {/* Cross */}
          <rect x="18.5" y="12" width="3" height="11" rx="0.8" fill={theme === 'dark' ? '#1F2937' : 'white'} />
          <rect x="14" y="16.5" width="11" height="3" rx="0.8" fill={theme === 'dark' ? '#1F2937' : 'white'} />
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={`shieldGradientFull-${size}`} x1="30" y1="10" x2="30" y2="50" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor={theme === 'dark' ? '#60A5FA' : '#3B82F6'} />
          <stop offset="100%" stopColor={theme === 'dark' ? '#3B82F6' : '#2563EB'} />
        </linearGradient>
      </defs>
      ...
      <g id="icon">
        ...
        {/* Cross */}
        <g opacity="0.95">
          <rect x="27.5" y="20" width="5" height="18" rx="1.5" fill={theme === 'dark' ? '#1F2937' : 'white'} />
          <rect x="21" y="26.5" width="18" height="5" rx="1.5" fill={theme === 'dark' ? '#1F2937' : 'white'} />
        </g>
